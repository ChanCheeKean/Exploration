...
WikiDocPair = _reflection.GeneratedProtocolMessageType('WikiDocPair', (_message.Message,), dict(
...
WikiDoc = _reflection.GeneratedProtocolMessageType('WikiDoc', (_message.Message,), dict(
  DESCRIPTOR = _WIKIDOC,
  __module__ = 'wiki_doc_pair_pb2'
